            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/brands/andromeda.png"
                    alt="logo"
                  ...
                  <Image
                    src="/images/brands/andromeda.png"
                    alt="logo"
                    className="hidden w dark:block"
                    width={60}
                    height={60}
                  />
                </Link>
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Contact Eric at eric@andromedaservices.org for innovative web and SEO solutions.
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              All Rights Reserved. <a href="#" rel="nofollow noopener">AndroMeda Services</a>
            </p>
          </div>
        </div>
